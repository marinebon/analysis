...
#trial1 = rvc_tbl %>%
  #spread(year, eff_simpson)

#trial2 = spread(rvc_tbl, year, eff_simpson)

#trial3 = rvc_tbl %>%
  #spread(year, mean(eff_simpson))

#trial4 = spread(rvc_tbl, year, mean(eff_simpson))

#trial5 = rvc_tbl %>%
  #spread(data_wide, eff_simpson)

#trial6 = rvc_tbl %>%
  #select(data_wide, eff_simpson) 
#trial6.2 = spread(trial6, data_wide, eff_simpson, fill=0)

trial7 = mean(rvc_tbl$eff_simpson[[15]])



#mean(rvc_tbl$eff_simpson[[15]])
...
#dim(w_mcq) 15, 2 (needs to be years * species (333))
