...
ggplot(data = rvc_tbl, aes(x = year)) +
  ...
  scale_color_hue(labels = c("Simpson", "Shannon"))
...
- 'protection' refers only to DT data. 0 = not protected, 1 = protected, T North Ecological Reserve, 2 = protected, Dry Tortugas Park 
- "mapNumber" = "mpaNumner" : use MPA 0 - 27 
